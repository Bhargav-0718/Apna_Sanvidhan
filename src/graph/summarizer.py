...
class Summarizer:
    ...
    def summarize_chunks(
        ...
        summaries = {}
        iterable = tqdm(chunks, desc="Summarizing chunks", unit="chunk", file=sys.stdout, disable=False) if self.show_progress else chunks
    ...
    def summarize_communities(
        ...
        community_summaries = {}
        iterable = tqdm(communities.items(), total=len(communities), desc="Summarizing communities", unit="community", file=sys.stdout, disable=False) if self.show_progress else communities.items()
