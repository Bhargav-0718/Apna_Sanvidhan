...
class LocalSearch:
    ...
    def compute_chunk_embeddings(self, chunks: List[Dict[str, Any]]):
        ...
        """
        logger.info(f"Computing embeddings for {len(chunks)} chunks using batch processing")
        
        # Extract chunk texts
        chunk_texts = {chunk["chunk_id"]: chunk.get("text", "") for chunk in chunks}
        ...
        self.chunk_embeddings.update(embeddings_dict)
